...
class ModelPredictiveController():
    def __init__(self, quad_parameters, x0, xref, Ts = 0.1, linear_model=LinearizedQuad):
        self.Ts = Ts
        ...
        #cost parameters
        self.Qx = sparse.diags([10, 10, 100, 0, 0, 0])  # Quadratic cost for states x0, x1, ..., x_N-1
