...
SUBSCRIPTIONS_MAPPING = {
    ...
    'SET_SQUARE_SETPOINT': ['change_setpoint_callback'],
...
MQTT_DATATYPES_MAPPING = {
    ...
    'SET_SQUARE_SETPOINT': lambda data: float(data),
...
MODES = ['STABILIZE', 'ACRO', 'GUIDED', 'RTL', 'LAND', 'POSHOLD', 'LOITER', 'ALT_HOLD', 'GUIDED_NOGPS']
