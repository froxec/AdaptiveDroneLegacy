...
from ModelsFactory.model_parameters import quad_parameters, pendulum_parameters, Z550_parameters
...
if __name__ == '__main__':
    ...
    thrust_setpoint = 500
    attitude_setpoint = np.array([deg2rad(30), deg2rad(0), deg2rad(0)])
    # plot_process.start()
